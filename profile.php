...
<!--                            <img src="man.png" alt="" class="img-circle img-responsive" />-->
                    ...
                    <div class="col-md-11" id="user-option">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            ...
                            <li role="presentation">
                                <a href="#settings" aria-controls="settings" role="tab" class="text-center" data-toggle="tab" style="width: 150px;">My orders </a>
                            </li>
                            <?php
                                ...
                                <div class="mail">
                                    ...
                                    <div class="agile_mail_grids">
                                        <div class="col-md-4 contact-left">
                                            <h4>Address</h4>
                                            <p>202/6,Main Street,Kalutara South
                                               </p>
                                            <ul>
                                                <li>Mobile Phone :+94 775 499 883</li>
                                                <li>Telephone :+94 34 222 5555</li>
                                                
                                                <li><a href="raneshamadurya@gmail.com">raneshamadurya@gmail.com</a></li>
                                            </ul>
                                        </div>
                                    ...
                                    <?php $userCart = $cartObject->getOrderedProductByUserId(Session::get("userId")); if (!$userCart): ?>
                                        <div class="empty" style="margin-top: 15px; margin-bottom: 10px">
                                            <div class="alert alert-warning alert-dismissable">
                                                ...
                                                <strong>Warning! </strong>No hires .
                                            </div>
                                        </div>
                                    <?php else: $i = 0; ?>

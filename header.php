...
<body>
    ...
    <div class="container">
        ...
        <div class="search">
            <input class="search_box" type="checkbox" id="s">
            <label class="icon-search" for="s"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></label>
            ...
            <div class="search_form">
                <form action="#" method="post">
                    <input type="text" name="Search" placeholder="Search a service..." />
